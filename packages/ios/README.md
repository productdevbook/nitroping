...
`fetchPublicConfig()` loads the safe widget theme and project categories for custom native forms. `NitroPingFollowUpView` provides a scoped SwiftUI status screen for a magic-link token.
