/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: 5954d6ab5c8f6b48bd4eb8cc36533dc9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUDIENCE" | "OIDC_ISSUER_URL" | "OIDC_AUDIENCE" | "EMAIL_FROM" | "PUBLIC_APP_URL" | "TURNSTILE_SITE_KEY" | "CUSTOM_HOSTNAME_ZONE_ID" | "CUSTOM_HOSTNAME_ZONE_NAME" | "CUSTOM_HOSTNAME_FALLBACK_ORIGIN">> {}
}
