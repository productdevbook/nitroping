/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: 86b799e11ff87d9956e820e7f9b4bf93)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	CACHE: KVNamespace;
	ATTACHMENTS: R2Bucket;
	DB: D1Database;
	FEEDBACK_SEARCH: VectorizeIndex;
	EMAIL: SendEmail;
	...
	ACCESS_TEAM_DOMAIN: "https://anadolu-ekspresi.cloudflareaccess.com";
	ACCESS_AUDIENCE: "b269ef7350f4c5fae49034984f7dcca401553077292e0ca118f985a01e32358c";
	OIDC_ISSUER_URL: "";
	OIDC_AUDIENCE: "";
	EMAIL_FROM: "notifications@nitroping.dev";
	PUBLIC_APP_URL: "https://nitroping.dev";
	GITHUB_CLIENT_ID: "Ov23li7Zlq0BmTXg0zFF";
	TURNSTILE_SITE_KEY: "";
	CUSTOM_HOSTNAME_ZONE_ID: "";
	CUSTOM_HOSTNAME_ZONE_NAME: "nitroping.dev";
	CUSTOM_HOSTNAME_FALLBACK_ORIGIN: "";
	EVENT_STREAM: DurableObjectNamespace<import("./index").ProjectEventStream>;
	SITE: Fetcher /* nitroping-site */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "ProjectEventStream";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUDIENCE" | "OIDC_ISSUER_URL" | "OIDC_AUDIENCE" | "EMAIL_FROM" | "PUBLIC_APP_URL" | "GITHUB_CLIENT_ID" | "TURNSTILE_SITE_KEY" | "CUSTOM_HOSTNAME_ZONE_ID" | "CUSTOM_HOSTNAME_ZONE_NAME" | "CUSTOM_HOSTNAME_FALLBACK_ORIGIN">> {}
}
