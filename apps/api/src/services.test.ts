...
const sample: Feedback = {
  ...
  title: "Ödeme ekranı", body: "Açılmıyor", metadata: {}, createdAt: "2026-01-01T00:00:00.000Z", updatedAt: "2026-01-01T00:00:00.000Z",
};
...
describe("feedback service boundaries", () => {
  it("passes tenant context through every repository operation", async () => {
    ...
    await Effect.runPromise(createFeedback(repository, context, { type: "bug", title: "Başlık", body: "Gövde" }, "req_1"));
